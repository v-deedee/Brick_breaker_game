...
public:
	...
	void initializeSDL();
	void update_game(bool& is_set_start_pos, bool& lose_lives_check, int& die_number, bool& is_running, const std::string& l_text,
	...
	void handle_items(bool& items_appearing, const int& item_index);
	void run();
	void close();
